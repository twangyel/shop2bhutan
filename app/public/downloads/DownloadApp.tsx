    ...
    <div className="min-h-screen bg-white text-slate-950">
        ...
        <div className="mx-auto flex max-w-3xl items-center justify-between px-4 pb-3 pt-[calc(env(safe-area-inset-top)+0.85rem)]">
          ...
          >
            <span className="min-w-0">
              <Logo size="md" />
              <span className="mt-0.5 block pl-12 text-[10px] font-semibold tracking-wide text-slate-400">
                Official app access
              </span>
            </span>
          </a>
      ...
      <main className="mx-auto max-w-3xl px-4 py-6 sm:py-10">
        <section className="text-center">
          <div className="relative mx-auto flex h-24 w-24 items-center justify-center rounded-[26px] border border-slate-200 bg-white shadow-sm">
