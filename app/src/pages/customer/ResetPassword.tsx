...
>
 ...
 type="button"
 onClick={() => navigate('/login')}
 className="flex items-center gap-2 text-sm text-gray-500 mb-6 hover:text-gray-700"
>
 <ArrowLeft size={18} />
 Back to Login
 </button>
 ...
 <div>
 <label className="block text-xs font-medium text-gray-700 tracking-wider mb-1.5">
 New password
 </label>
 ...
 className="w-full h-12 pl-10 pr-10 border border-gray-300 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/10"
 />
...
>
 ...
 className="w-full h-12 pl-10 pr-4 border border-gray-300 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/10"
 />
 </div>
 </div>
